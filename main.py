...
# Select JSON input
fpInput = open("data/400.json", "r", encoding="utf8")
# print(fp.read())
...
for game in data:
    ...
    with model.chat_session():
        review = model.generate(
            ...
            + "with an explanation of each mechanic. the next section will be 'components and artwork' this section should be 2 or 3 paragraphs long "
